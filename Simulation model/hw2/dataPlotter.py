...
class dataPlotter:
    ...
    def __init__(self):
        ...
        self.handle.append(myPlot(self.ax[4], xlabel='t(s)', ylabel='force(N)',title='vtol thurst'))
    ...
    def update(self, t, reference, states, ctrl):
        ...
        self.theta_history.append(180.0/np.pi*states.item(3))  # arm angle (converted to degrees)
        theta = 180.0/np.pi*states.item(3)
        ...
        self.handle[4].update(self.time_history, [self.Force_history])
